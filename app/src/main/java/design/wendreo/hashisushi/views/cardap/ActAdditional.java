...
public class ActAdditional extends AppCompatActivity implements View.OnClickListener {

    private FloatingActionButton flotBntVoltarA;
    private FloatingActionButton flotBntFinishA;
    private FloatingActionButton flotBntDrinksA;
    private TextView txtQuantItensA;
    private TextView txtTotalOrderA;

    private TextView txtCardapA;
    private TextView txtAddional;
    ...
    private RecyclerView lstAdditional;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_additional);
    ...
    private void recycleOnclick ( ) {
        ...
        lstAdditional.addOnItemTouchListener (
    ...
    private void recyclerViewConfig ( ) {
        ...
        lstAdditional.setLayoutManager ( new LinearLayoutManager( this ) );
        lstAdditional.setHasFixedSize ( true );
        adapterProduct = new AdapterProduct ( productsList, this );
        lstAdditional.setAdapter ( adapterProduct );
    ...
    public void onClick ( View v ) {
        ...
        if ( v.getId ( ) == R.id.flotBntVoltarA ) {

            startVibrate ( 90 );
            finish ( );

        }
        if ( v.getId ( ) == R.id.flotBntFinishA ) {
        ...
        if ( v.getId ( ) == R.id.flotBntDrinksA ) {
    ...
    private void fontLogo ( ) {
        ...
        txtAddional.setTypeface ( font );
    }

    private void openDrinks ( ) {

        Intent intent = new Intent ( ActAdditional.this, ActDrinks.class );
        ...
        ActivityCompat.startActivity ( ActAdditional.this, intent, actcompat.toBundle ( ) );
    ...
    public void initDB ( ) {
        FirebaseApp.initializeApp ( ActAdditional.this );
        this.reference = FirebaseDatabase.getInstance ( ).getReference ( );
    }

    private void initComponent ( ) {

        txtQuantItensA = findViewById ( R.id.txtQuantItensA );
        txtTotalOrderA = findViewById ( R.id.txtTotalOrderA );

        flotBntVoltarA = findViewById ( R.id.flotBntVoltarA );
        flotBntFinishA = findViewById ( R.id.flotBntFinishA );
        flotBntDrinksA = findViewById ( R.id.flotBntDrinksA );

        txtCardapA = findViewById ( R.id.txtCardapA );
        txtAddional = findViewById ( R.id.txtAddional );

        flotBntVoltarA.setOnClickListener ( this );
        flotBntFinishA.setOnClickListener ( this );
        flotBntDrinksA.setOnClickListener ( this );

        lstAdditional = findViewById ( R.id. lstAdditional );
    ...
    public void initSearch ( ) {
        ...
        Query querySearch = productDB.orderByChild ( "type" ).equalTo ( "Adicionais" );
    ...
    private void recoveryOrder ( ) {
        ...
        pedidoRef.addValueEventListener ( new ValueEventListener ( ) {
            ...
            public void onDataChange ( DataSnapshot dataSnapshot ) {
                ...
                txtQuantItensA.setText ( String.valueOf ( qtdItensCar ) );
                txtTotalOrderA.setText ( df.format ( totalCar ) );
                //fecha dialog
                dialog.dismiss ( );
